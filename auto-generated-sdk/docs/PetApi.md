...
with fds.sampleapi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = fds.sampleapi.PetApi(api_client)
    body = fds.sampleapi.Pet() # Pet | Pet object that needs to be added to the store
